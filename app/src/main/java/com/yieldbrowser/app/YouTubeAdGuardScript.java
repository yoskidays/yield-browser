...
final class YouTubeAdGuardScript {
    ...
    private static final String PAGE_SCRIPT =
            "(function(){'use strict';try{"
                    ...
                    + "function enabled(){try{return !!(window.__yieldShieldV2State&&window.__yieldShieldV2State.config&&window.__yieldShieldV2State.config.enabled);}catch(x){return false;}}"
                    ...
                    + "function hideAds(){try{document.querySelectorAll(HIDE).forEach(function(e){try{e.setAttribute('data-yield-yt-ad-hidden','1');e.style.setProperty('display','none','important');e.setAttribute('aria-hidden','true');}catch(x){}});}catch(x){}}"
                    + "function restoreHidden(){try{document.querySelectorAll('[data-yield-yt-ad-hidden=\"1\"]').forEach(function(e){try{e.style.removeProperty('display');e.removeAttribute('aria-hidden');e.removeAttribute('data-yield-yt-ad-hidden');}catch(x){}});}catch(x){}}"
                    ...
                    + "function run(){var v=video();if(!enabled()){restore(v);restoreHidden();return;}var skipped=clickSkips();hideAds();accelerateAd(skipped);}"
